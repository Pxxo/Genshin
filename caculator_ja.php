...
<head>
    ...
    <title>原神 樹脂計算機</title>
</head>

<body>
    <div class="card" id="card">
        <h3 class="title">原神 樹脂計算機</h3>
        <span id="range-value" class="afterHour"></span><br><input type="range" min="1" max="24" value="1" id="range"
            class="selectBar">
        <div class="result">
            <span id="now"></span><span>に</span><br class="displayBr"><span class="spotlight"
                id="result"></span><span>個たまります。</span>
        </div>
        <div class="options">
